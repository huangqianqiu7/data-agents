...
> **独立详细计划**：`@/c:/Users/18155/learn python/Agent/kddcup2026-data-agents-starter-kit-master/src/计划/待做/02-R6-corpus-recall-evaluation-plan.md`
>
> 该计划已拆出本节为独立 md，含 E3/E1/E2 各阶段的 checkbox 步骤、分析脚本设计、评估报告模板与回写约定。
> **执行规则**：详细计划执行完毕后，**必须回到本文件 §3** 把状态行改为 `✅ 已完成` 并补"实施结果"小节（见独立计划 §8 "回写父 followup"）。
> 在回写发生前，本节"### 背景 / 候选实验 / 涉及文件"等内容保持原貌作为 self-contained 摘要。
...
- §3 R6 独立详细计划：`@/c:/Users/18155/learn python/Agent/kddcup2026-data-agents-starter-kit-master/src/计划/待做/02-R6-corpus-recall-evaluation-plan.md`
